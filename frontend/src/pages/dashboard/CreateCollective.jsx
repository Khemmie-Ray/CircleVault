...
const CreateCollective = () => {
  ...
  const handleCreateThrift = async () => {
    ...
    setSavingFrequency("");
    setloading(false);
    navigate("/dashboard/collective-vault");
  };

  return (
    <div>
      <DashNav>Create Collective Vault</DashNav>
      <div className="bg-white my-6 mx-8 p-6">
        ...
        <div className="w-[100%] lg:w-[50%] md:w-[60%] mx-auto my-8">
          ...
          <button
            ...
            className={`rounded-full text-white py-3 px-6 mt-3 text-[16px] flex justify-center hover:scale-105 items-center w-[100%] font-[500] bg-gradient-to-r hover:from-lightPurple hover:to-dark cursor-pointer ${
              loading ? "from-lightPurple to-dark" : "from-primary to-dark"
            }`}
          >
