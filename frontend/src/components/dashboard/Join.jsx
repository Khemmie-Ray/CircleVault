...
const Join = ({ thriftAddress }) => {
  ...
  return (
    <>
      <Button
        onClick={open}
        className="bg-linear-to-r from-primary to-dark font-[500] text-white py-3 px-6 mb-3 text-[12px] flex justify-center rounded-full hover:scale-105 items-center"
      >
        Join
      </Button>
